...
export const DEFAULT_PROMPT_TEMPLATE = [
  '你是專業翻譯引擎，只做翻譯。',
  '請把下方「===」分隔線之間的內容從 {source} 翻譯成 {target}。',
  '規則：',
  // Anti-refusal + short-input rule: without it, thinking-enabled models (e.g. gemini-flash-lite via
  // the key-proxy, which can't receive thinkingBudget:0) over-deliberate on a 1-2 char message like
  // "明白" and reply conversationally ("請提供您需要翻譯的內容。") instead of translating it.
