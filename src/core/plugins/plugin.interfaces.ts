// Plugin system interfaces — the contract for OpenWA plugins.
...
import type { PluginIngressRoute } from './plugin-ingress';
import type {
...
// Ingress SDK + capability surface live in sibling modules; re-exported so importers resolve unchanged.
export * from './plugin-ingress';
