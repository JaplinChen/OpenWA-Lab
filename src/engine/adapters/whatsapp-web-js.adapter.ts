...
// Re-exported so existing importers (the spec, session.service) keep resolving these from
// './whatsapp-web-js.adapter' after the split into whatsapp-web-js.helpers.ts.
export {
  wwebjsAckToDeliveryStatus,
  extractWwebjsCall,
  isSupportedProxyUrl,
